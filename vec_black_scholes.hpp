...
inline Vec16f bsPriceVec(const bool iscall, const Vec16f ul, const Vec16f tte,
                         const Vec16f strike, const Vec16f rate,
                         const Vec16f vol) {
...
inline Vec16f bisectIVVec(const bool iscall, const Vec16f ul, const Vec16f tte,
                          const Vec16f strike, const Vec16f rate,
                          const Vec16f price) {
